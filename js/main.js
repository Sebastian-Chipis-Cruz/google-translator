//Strings
const CFG_SECTION = "googleTranslator";
const CFG_QUERY = "QueryTemplate";
const CMD_ID = "extension.googleTranslator";
...
function webSearch() {
  ...
  const googleTranslator = vscode.workspace.getConfiguration(CFG_SECTION);
  const queryTemplate = googleTranslator.get(CFG_QUERY);
